...
// 4. Clear current memo
clearBtn.addEventListener('click', () => {
  if (memoArea.value && confirm('Are you sure you want to clear the current memo?')) {
    memoArea.value = '';
...
// 5. Save current memo to saved list
...
function downloadDocx(memo) {
  ...
  const html = '<!DOCTYPE html>' +
    ...
    '<style>body{font-family:Calibri,sans-serif;font-size:14px;line-height:1.6;padding:20px;} p{margin:0 0 8px 0;}</style>' +
    '</head><body>' + contentLines + '</body></html>';
